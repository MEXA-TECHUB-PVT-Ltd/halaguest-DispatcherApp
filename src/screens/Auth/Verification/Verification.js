    ...
    axios({
      ...
      .then(async function (response) {
        ...
        if (response.data.message === 'Dispacher Exists') {
          // && response.data.data.hotel_id.length>0
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={Authtextstyles.textview}>
        ...
        <Text style={Authtextstyles.subtext}>
          Please enter code that you received on your phone number
        </Text>
      </View>
      ...
      <CustomModal
        ...
        rightbuttontext={'OK'}
        onPress={() => {
          setModalVisible2(false), navigation.navigate('BottomTab');
        }}
      />
    </SafeAreaView>
  );
