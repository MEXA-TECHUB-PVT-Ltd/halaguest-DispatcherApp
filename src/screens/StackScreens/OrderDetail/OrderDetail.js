  ...
  return (
   ...
   <View style={styles.userdetail}>
    ...
    //     orderAssignedTo.image}}
     style={{height:wp(15),width:wp(15),borderColor:Colors.activeinputs,
    borderWidth:2,borderRadius:wp(10)  }}
     />
...
<View style={{height:hp(18),width:wp(85),alignItems:'center',alignSelf:'center',justifyContent:'center'}}>
<View style={styles.mapcontainer}>
        <MapView 
            style={styles.map} 
            initialRegion={{
              latitude: -31.385839,
              longitude: 116.528069,
