...
const DriverOrders = ({ navigation,route }) => {
console.log('here prop',route.params)
...
ScheduleOrders.map((item, key) => (
    <TouchableOpacity
    activeOpacity={true}
    onPress={()=>navigation.navigate('OrderDetail',{orderid:item._id,navplace:'Schedule'})}>
<OrdersCards
            ...
            OngoingOrders.map((item, key) => (
                <TouchableOpacity 
                activeOpacity={true}
                onPress={()=>navigation.navigate('TripRoute',{orderid:item._id,
        ...
        : Complete ? (
            ...
            CompleteOrders.map((item, key) => (
                <TouchableOpacity
                activeOpacity={true}
                 onPress={()=>navigation.navigate('OrderDetail',{orderid:item._id,navplace:'Completed'})}>
            <OrdersCards                        
                                                  time={item.flight_time}
         ...
         : Cancel ? (
            ...
            CancelOrders.map((item, key) => (
                <TouchableOpacity
                activeOpacity={true}
                 onPress={()=>navigation.navigate('OrderDetail',{orderid:item._id,navplace:'Cancel'})}>
            <OrdersCards                        
                                                  time={item.flight_time}
                                                  date={item.flight_date}
                                                   price={item.total_amount+'$'}
